                        ...
                        <tr>
                            <td
                                ...
                                <h1
                                    ...
                                    BERITA ACARA PEMINJAMAN BARANG (BAPB)
                                </h1>
                            </td>
                        </tr>
                                            ...
                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="font-size: 12px; color: #2c3e50; padding-bottom: 6px;">
                                                        <strong
                                                            style="color: #1e3c72; font-weight: 600;">{{ $bapb->bapb_reg }}</strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td
                                                    ...
                                                    <td style="font-size: 12px; color: #2c3e50; padding-bottom: 6px;">
                                                        {{ \Carbon\Carbon::parse($bapb->bapb_date)->locale('id')->isoFormat('D MMMM YYYY') }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td
                                    ...
                                    <tr>
                                        <td style="padding: 12px 15px; background-color: #ffffff;">
                                            <p
                                                ...
                                                Barang tersebut dipinjam dengan keadaan baik dan diketahui oleh
                                                ...
                                                barang tersebut selama masa peminjaman.
                                            </p>
                                            <p
                                                ...
                                                Demikian berita acara peminjaman barang ini dibuat untuk dapat
                                        ...
                                        <tr>
                                            <td style="padding: 10px 15px;">
                                                <p
                                                    ...
                                                    Signed BAPB document is attached to this email.<br>
                                                    File: <strong
                                                        style="color: #1b5e20;">BAPB_Signed_Document_{{ $bapb->bapb_reg }}.{{ pathinfo($bapb->signed_document, PATHINFO_EXTENSION) }}</strong>
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
