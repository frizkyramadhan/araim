              ...
              <div class="card-tools">
                <ul class="nav nav-pills ml-auto">
                  <li class="nav-item mr-2">
                    <a class="btn btn-primary" href="{{ url('bapbs/' . $bapb->bapb_no . '/edit') }}"><i class="fas fa-pen-square"></i>
                      Edit</a>
                    <a class="btn btn-success" href="{{ url('bapbs/' . $bapb->bapb_no . '/print') }}"><i class="fas fa-print"></i>
                      Print</a>
