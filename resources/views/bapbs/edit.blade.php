              ...
              <div class="card-body">
                <div class="tab-content p-0">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="hidden" class="form-control @error('bapb_no') is-invalid @enderror" name="bapb_no" placeholder="BAPB No." value="{{ $bapb->bapb_no }}" required readonly>
                      <input type="text" class="form-control @error('bapb_reg') is-invalid @enderror" name="bapb_reg" placeholder="BAPB No." value="{{ $bapb->bapb_reg }}" required readonly>
                      @error('bapb_reg')
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="date" class="form-control @error('bapb_date') is-invalid @enderror" name="bapb_date" value="{{ old('bapb_date', $bapb->bapb_date) }}">
                      @error('bapb_date')
                      <div class="error invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select name="bapb_submit" class="form-control @error('bapb_submit') is-invalid @enderror select2bs4" style="width: 100%;">
                        ...
                        <option value="{{ $submit->id }}" {{ old('bapb_submit', $bapb->bapb_submit) == $submit->id ? 'selected' : '' }}>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      ...
                      <select id="bapb_receive" class="form-control @error('bapb_receive') is-invalid @enderror select2bs4" style="width: 100%;" disabled>
                        <option value="">-- Select Employee --</option>
                        @foreach ($receives as $receive)
                        <option value="{{ $receive->id }}" {{ old('bapb_receive', $bapb->bapb_receive) == $receive->id ? 'selected' : '' }}>
                    ...
                    <div class="table-responsive">
                      <table id="inventories" class="table table-sm table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>
                              <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure to delete this item?')" value="deleteRow{{ $rows->bapb_id }}" name="deleteRow{{ $rows->bapb_id }}"><i class="fas fa-trash-alt"></i></button>
                            </td>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control @error('duration') is-invalid @enderror" name="duration" value="{{ old('duration', $bapb->duration) }}">
                      @error('duration')
                      <div class="error invalid-feedback">
                        {{ $message }}
                      </div>
