                                ...
                                <div class="card-body">
                                    <div class="tab-content p-0">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="hidden"
                                                    ...
                                                    name="bapb_no" placeholder="BAPB No." value="{{ $bapb->bapb_no }}"
                                                    required readonly>
                                                <input type="text"
                                                    class="form-control @error('bapb_reg') is-invalid @enderror"
                                                    name="bapb_reg" placeholder="BAPB No." value="{{ $bapb->bapb_reg }}"
                                                    required readonly>
                                                @error('bapb_reg')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="date"
                                                    ...
                                                    name="bapb_date" value="{{ old('bapb_date', $bapb->bapb_date) }}">
                                                @error('bapb_date')
                                                    <div class="error invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="hidden" name="bapb_receive"
                                                    value="{{ $bapb->bapb_receive }}">
                                                <select id="bapb_receive"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <button type="submit" class="btn btn-sm btn-danger"
                                                                        ...
                                                                        value="deleteRow{{ $rows->bapb_id }}"
                                                                        name="deleteRow{{ $rows->bapb_id }}"><i
                                                ...
                                                <table id="inventories" class="table table-sm table-striped">
                                                    ...
                                                    <tbody>
                                                        @foreach ($inventories as $rows)
                                                            <tr>
                                                                <td>
                                                                    <input type="checkbox" name="inventory_id[]"
                                                                        id="{{ $rows->id }}"
                                                                        value="{{ $rows->id }}">
                                                                </td>
                                                                <td>{{ $rows->inventory_no }}</td>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text"
                                                    ...
                                                    name="duration" value="{{ old('duration', $bapb->duration) }}">
                                                @error('duration')
                                                    <div class="error invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                ...
                success: function(inventories) {
                    ...
                    $.each(inventories, function(index, inventory) {
                        ...
                        row += '<td><input type="checkbox" name="inventory_id[]" id="' +
                            inventory.id + '" value="' + inventory.id +
                            '"></td>';
