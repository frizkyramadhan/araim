										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control @error('project_code') is-invalid @enderror" name="project_code"
													value="{{ old('project_code', $project->project_code) }}" placeholder="Project Code">
												@error('project_code')
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control @error('project_name') is-invalid @enderror" name="project_name"
													value="{{ old('project_name', $project->project_name) }}" placeholder="Project Code">
												@error('project_name')
													<div class="error invalid-feedback">
														{{ $message }}
													</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<select name="project_status" class="form-control @error('project_status') is-invalid @enderror">
													<option value="1" {{ old('project_status', $project->project_status) == '1' ? 'selected' : '' }}>
														Active</option>
													<option value="0" {{ old('project_status', $project->project_status) == '0' ? 'selected' : '' }}>Inactive
													</option>
												</select>
