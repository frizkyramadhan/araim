				...
				<div class="col-md-8 offset-md-2">
					<form action="{{ url()->current() }}" method="get">
						<div class="input-group">
							<input id="search" name="search" type="search" class="form-control form-control-lg"
								placeholder="Type your Inventory Number or Serial Number here" value="{{ request('search') }}" autofocus>
									...
									<div class="list-group-item">
										<div class="row">
											<div class="col px-2">
												...
												<div id="collapseOne{{ $tracking->id }}" class="collapse" data-parent="#accordion">
													<div>
														<hr>
														<div class="row">
															<div class="col-md-6">
															...
															<div class="col-md-12">
																<div class="table-responsive">
																	<?php
																	// make query to get specification data
																	$conn = mysqli_connect('localhost', 'root', 'SkyF1sh2020', 'arka_assets');
																	$query = "SELECT specifications.*, components.component_name FROM specifications JOIN components ON specifications.component_id = components.id WHERE inventory_id = '$tracking->id' ORDER BY id ASC";
																	$specifications = mysqli_query($conn, $query);
																	?>
																	<table class="table table-sm table-borderless" width="100%">
																		<tr>
