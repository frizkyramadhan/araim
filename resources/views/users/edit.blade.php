                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select name="level" class="form-control @error('level') is-invalid @enderror select2bs4">
                        ...
                        <option value="superuser" {{ old('level', $user->level) == 'superuser' ? 'selected' : '' }}>Superuser
                        </option>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="custom-control custom-checkbox">
                    <input class="custom-control-input" type="checkbox" id="categoryCheckbox{{ $category->id }}" name="categories[]" value="{{ $category->id }}" {{ $user->categories->contains($category->id) ? 'checked' : '' }}>
