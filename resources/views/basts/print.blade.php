...
<title>Form Berita Acara Serah Terima #{{ $bast->bast_no }} - Arkananta Asset Inventory Management</title>
<style type="text/css">
...
<table width="100%" border="0" cellspacing="0" class="kop">
  <tr>
    <td width="256" rowspan="4"><div align="center"><img src="{{ asset('assets/dist/img/logo.png') }}" width="225" height="55" /></div></td>
...
<table width="100%" border="0" cellspacing="0" class="no">
  ...
  <tr>
    <td class="style3"><div align="center"><b>No	: {{ $bast->bast_reg }}</b></div></td>
  </tr>
</table>
<br><br>
<table width="100%" border="0" cellspacing="15" class="emp">
  ...
  <tr>
    ...
    <td width="92">Nama</td>
    <td width="14">:</td>
    <td width="826">{{ $bast->submit_name }}</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>NIK</td>
    <td>:</td>
    <td>{{ $bast->submit_nik }}</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Jabatan</td>
    <td>:</td>
    <td>{{ $bast->submit_pos }}</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>NIK</td>
    <td>:</td>
    <td>{{ $bast->receive_nik }}</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Jabatan</td>
    <td>:</td>
    <td>{{ $bast->receive_pos }}</td>
  </tr>
  <tr>
...
<table width="100%" border="0" cellspacing="0" class="inv">
  ...
  @foreach ($bast_row as $row)
    <td class="style3"><div align="center">{{ $loop->iteration }}</div></td>
    <td class="style3">{{ $row->asset_name }} {{ $row->brand }} {{ $row->model_asset }}</td>
    <td class="style3"><div align="center">{{ $row->quantity }}</div></td>
    <td class="style3"><div align="center">{{ $row->serial_no }}</div></td>
    <td class="style3"><div align="center">{{ $row->remarks }}</div></td>
  </tr>
  @endforeach
</table>
