                                    ...
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item mr-2">
                                            <a class="btn btn-primary"
                                                href="{{ url('basts/' . $bast->bast_no . '/edit') }}"><i
                                                    class="fas fa-pen-square"></i>
                                                Edit</a>
                                            <a class="btn btn-success"
                                                href="{{ url('basts/' . $bast->bast_no . '/print') }}"><i
                                                    class="fas fa-print"></i>
                                                Print</a>
                                            {{-- <a class="btn btn-info"
                                                href="{{ url('basts/' . $bast->bast_no . '/preview-email') }}"
                                                target="_blank"><i class="fas fa-envelope-open-text"></i>
                                                Preview Email</a> --}}
                                            <a class="btn btn-warning text-dark" href="{{ url('basts') }}"><i
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="card card-primary">
                                            <div class="card-header">
                                                <h3 class="card-title">BAST Detail</h3>
                                                <div class="card-tools">
                                            ...
                                            <div class="card-body">
                                                <table width=100% class="table table-sm table-borderless">
                                                    ...
                                                    <tr>
                                                        <td>Name</td>
                                                        <td style="width: 5%">:</td>
                                                        <td><b>{{ $bast->submit_name }}</b></td>
                                                    </tr>
                                                    <tr>
                                                        <td>NIK</td>
                                                        <td style="width: 5%">:</td>
                                                        <td><b>{{ $bast->submit_nik }}</b></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Position</td>
                                                        <td style="width: 5%">:</td>
                                                        <td><b>{{ $bast->submit_pos }}</b></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>Name</td>
                                                        <td style="width: 5%">:</td>
                                                        <td><b>{{ $bast->receive_name }}</b></td>
                                                    </tr>
                                                    <tr>
                                                        <td>NIK</td>
                                                        <td style="width: 5%">:</td>
                                                        <td><b>{{ $bast->receive_nik }}</b></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Position</td>
                                                        <td style="width: 5%">:</td>
                                                        <td><b>{{ $bast->receive_pos }}</b></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <!-- /.card-body -->
                                        ...
                                        <div class="card card-info">
                                            ...
                                            <div class="card-body">
                                                <form id="uploadDocumentForm"
                                                    action="{{ url('basts/' . $bast->bast_no . '/upload-document') }}"
                                                ...
                                                @if ($bast->signed_document)
                                                    <a href="{{ asset('storage/' . $bast->signed_document) }}"
                                                        target="_blank" class="btn btn-success">
                                                        <i class="fas fa-file-pdf"></i> View Signed Document
                                                    </a>
                                                    <form
                                                        action="{{ url('basts/' . $bast->bast_no . '/delete-document') }}"
                                        ...
                                        <div class="card card-success">
                                            ...
                                            <div class="card-body">
                                                <form id="sendEmailForm"
                                                    action="{{ url('basts/' . $bast->bast_no . '/send-email') }}"
                                                    method="POST">
                                                    @csrf
                                                    <div class="form-group">
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            var hasDocument = {{ $bast->signed_document ? 'true' : 'false' }};

            // If page reloaded with success message and document exists, enable button
            @if (session('success') && $bast->signed_document)
