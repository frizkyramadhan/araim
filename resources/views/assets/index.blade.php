								...
								<div class="card-tools">
									<ul class="nav nav-pills ml-auto">
										<li class="nav-item mr-2">
											<a class="btn btn-warning" href="{{ url('assets/create') }}"><i class="fas fa-plus"></i>
												Add</a>
										</li>
									</ul>
								</div>
										...
										<tbody>
											@foreach ($assets as $asset)
												<tr>
													...
													<td>{{ $asset->category->category_name ?? 'null' }}</td>
													...
													<td class="text-center">
														<a class="btn btn-icon btn-primary" href="{{ url('assets/' . $asset->id . '/edit') }}"><i
