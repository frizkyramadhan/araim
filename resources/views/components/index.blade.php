								...
								<div class="card-tools">
									<ul class="nav nav-pills ml-auto">
										<li class="nav-item mr-2">
											<a class="btn btn-warning" href="{{ url('components/create') }}"><i class="fas fa-plus"></i>
												Add</a>
										</li>
									</ul>
								</div>
										...
										<tbody>
											@foreach ($components as $component)
												<tr>
													...
													<td class="text-center">
														<a class="btn btn-icon btn-primary" href="{{ url('components/' . $component->id . '/edit') }}"><i
																class="fas fa-pen-square"></i></a>
														<form action="{{ url('components/' . $component->id) }}" method="post"
