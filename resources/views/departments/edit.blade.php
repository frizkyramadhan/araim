								...
								<div class="card-tools">
									<ul class="nav nav-pills ml-auto">
										<li class="nav-item mr-2">
											<a class="btn btn-warning" href="{{ url('departments') }}"><i class="fas fa-undo-alt"></i>
												Back</a>
										</li>
									</ul>
								</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control @error('dept_name') is-invalid @enderror" name="dept_name"
													value="{{ old('dept_name', $department->dept_name) }}" placeholder="Department Name">
												@error('dept_name')
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<select name="dept_status" class="form-control @error('dept_status') is-invalid @enderror">
													<option value="1" {{ old('dept_status', $department->dept_status) == '1' ? 'selected' : '' }}>
														Active</option>
													<option value="0" {{ old('dept_status', $department->dept_status) == '0' ? 'selected' : '' }}>Inactive
													</option>
												</select>
												@error('dept_status')
