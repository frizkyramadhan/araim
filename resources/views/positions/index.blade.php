								...
								<div class="card-tools">
									<ul class="nav nav-pills ml-auto">
										<li class="nav-item mr-2">
											<a class="btn btn-warning" href="{{ url('positions/create') }}"><i class="fas fa-plus"></i>
												Add</a>
										</li>
									</ul>
								</div>
										...
										<tbody>
											@foreach ($positions as $position)
												<tr>
													...
													<td>{{ $position->department->dept_name ?? 'null' }}</td>
													...
													<td class="text-center">
														<a class="btn btn-icon btn-primary" href="{{ url('positions/' . $position->id . '/edit') }}"><i
