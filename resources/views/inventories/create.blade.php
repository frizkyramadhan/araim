	...
	<section class="content">
		<div class="container-fluid">
			<div class="row">
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<input type="text" class="form-control @error('model_asset') is-invalid @enderror" name="model_asset"
																value="{{ old('model_asset') }}" tabindex="5">
															@error('model_asset')
																<div class="error invalid-feedback">
																	{{ $message }}
																</div>
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<input type="text" class="form-control @error('serial_no') is-invalid @enderror" name="serial_no"
																value="{{ old('serial_no') }}" tabindex="6">
															@error('serial_no')
																<div class="error invalid-feedback">
																	{{ $message }}
																</div>
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<input type="text" class="form-control @error('location') is-invalid @enderror" name="location"
																value="{{ old('location') }}" tabindex="12">
															@error('location')
																<div class="error invalid-feedback">
																	{{ $message }}
																</div>
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<input type="text" class="form-control @error('reference_no') is-invalid @enderror" name="reference_no"
																value="{{ old('reference_no') }}" tabindex="13">
															@error('reference_no')
																<div class="error invalid-feedback">
																	{{ $message }}
																</div>
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<input type="date" class="form-control @error('reference_date') is-invalid @enderror"
																name="reference_date" value="{{ old('reference_date') }}" tabindex="14">
                ...
                tabindex="16">{{ old('remarks') }}</textarea>
															@error('remarks')
																<div class="error invalid-feedback">
																	{{ $message }}
																</div>
