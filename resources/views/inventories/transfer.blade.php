				...
				<section class="col-lg-12">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="card card-secondary">
											...
											<form class="form-horizontal" action="{{ url('inventories/transferProcess/' . $inventory->id) }}"
												method="POST">
												@method('PATCH')
												@csrf
												<div class="card-body">
                    ...
                    tabindex="3">{{ old('remarks') }}</textarea>
												...
												<div class="card-footer">
													<button type="submit" class="btn btn-info float-right" tabindex="7"
														onclick="return confirm('Are you sure want to transfer this inventory?')">Submit</button>
												</div>
											</form>
										</div>
										<!-- /.card -->
