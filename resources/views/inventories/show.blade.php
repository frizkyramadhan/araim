              ...
              <div class="card-tools">
                <ul class="nav nav-pills ml-auto">
                  <li class="nav-item mr-2">
                    ...
                    <a class="btn btn-danger" href="{{ url('inventories/transfer/' . $inventory->id) }}"><i class="fas fa-exchange-alt"></i>
                      Transfer</a>
                    @if ($employee_id == null)
                    <a class="btn btn-primary" href="{{ url('inventories/edit/' . $inventory->id) }}"><i class="fas fa-pen-square"></i>
                      Edit</a>
                    @else
                    <a class="btn btn-primary" href="{{ url('inventories/edit/' . $inventory->id.'/'.$employee_id) }}"><i class="fas fa-pen-square"></i>
                      Edit</a>
                    @endif
                    @endif
                    @if ($employee_id == null)
                    ...
                    <div class="card-body">
                      <table width=100% class="table table-borderless">
                        ...
                        <tr>
                          <td>PIC</td>
                          <td style="width: 5%">:</td>
                          <td><b>{{ $inventory->fullname }}</b> - <b>{{ $inventory->nik }}</b></td>
                        </tr>
                        <tr>
                          <td>Date</td>
                          <td style="width: 5%">:</td>
                    ...
                    <div class="card-body text-center">
                      <table width=100% class="table table-borderless table-sm" style="padding: 0%">
                        ...
                        <tr>
                          <td>
                            @if ($inventory->qrcode)
                            <a href="{{ url('inventories/print_qrcode/' . $inventory->id) }}" target="_blank" class="btn btn-sm btn-primary">
                              <i class="fas fa-print"></i> Print
                            </a>
                            <a href="{{ url('inventories/delete_qrcode/' . $inventory->id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure to delete this qrcode?')">
                              <i class="fas fa-trash"></i> Delete
                            </a>
                            @elseif (!$inventory->qrcode)
                            <a href="{{ url('inventories/qrcode/' . $inventory->id) }}" class="btn btn-sm btn-secondary"><i class="fas fa-qrcode"></i> Generate</a>
                            @endif
                          </td>
                        </tr>
                      </table>
